            ...
            <tr>
                ...
                <td>
                    <a href="visualizar.php?id=<?php echo $um_nutricionista["codigo"]; ?>" title="Ver completo">
                        <img src="../img/visualizar.png" width="15" title="Visualizar funcionários" class="icone"></a>

                    <a href="editar.php ?id=<?php echo $um_nutricionista["codigo"]; ?>">
                        <img src="../img/editar.png" width="15" title="Editar dados do funcionário" class="icone"></a>

                    <a href="deletar.php?id=<?php echo $um_nutricionista['codigo']; ?>">
                        <img src="../img/deletar.png" width="15" title="Excluir funcionário" class="icone"></a>
                </td>
            </tr>
